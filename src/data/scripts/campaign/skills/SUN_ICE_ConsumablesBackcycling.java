...
public class SUN_ICE_ConsumablesBackcycling {
	...
	private static final int POPULATION_BONUS = 20;
	...
	public static class Level1 implements MarketSkillEffect, MarketImmigrationModifier {
		...
		public String getEffectDescription(float level) {
			return String.format(strings.get("consumables_backcycling_1"), POPULATION_BONUS);
		}
	...
	public static class Level2 implements MarketSkillEffect {
		...
		@Override
		public String getEffectDescription(float level) {
			return String.format(strings.get("consumables_backcycling_2"), DEMAND_REDUCTION);
		}
