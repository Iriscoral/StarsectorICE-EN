...
public class SUN_ICE_PdDroneMissileAI extends SUN_ICE_BaseMissileAI {
	private static final String WEAPON_ID = "sun_ice_hexac";
	private static final String MISSILE_ID = "sun_ice_pddrone";
	private static final float WEAPON_RANGE = 300f;
	...
	private static final float WEAPON_COOLDOWN = 0.5f;
	...
	public SUN_ICE_PdDroneMissileAI(MissileAPI missile) {
		super(missile);
